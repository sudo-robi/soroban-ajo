        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-2">
              <Link
                href="/"
                className="text-xl md:text-2xl lg:text-3xl font-bold text-blue-600 flex items-center gap-3"
              >
                <Image
                ...
                />
                <span className="hidden md:inline">Decentralized Rotational Savings</span>
              </Link>
            </div>
